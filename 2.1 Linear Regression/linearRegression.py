...
lin_reg_df = pd.read_csv('Real estate.csv')#YOUR CODE HERE
...
for rdm_st in random_state_list:
    ...
    RMSE = metrics.mean_squared_error(y_test, y_pred, squared=False) #YOUR CODE HERE -- remember RMSE is sqare root of MSE
