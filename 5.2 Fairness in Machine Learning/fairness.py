...
# Plan classifier without debiasing by using AdversarialDebiasing from inprocessing algorithms module and setting debias=False
# the parameters that are passed to AdversarialDebiasing are privileged_groups, unprivileged_groups, scope_name, debias, sess
...
# Use ClassificationMetric from metrics module to get all the classification metrics for the predicted and original test data
...
# Debiased classifier by using AdversarialDebiasing from inprocessing algorithms module and setting debias=True
...
print("Plain Model - Classification Accuracy: {:.2f}, Equal Opportunity Difference: {:.2f}".format(plain_model_classification_accuracy, plain_model_equal_opportunity_difference))
print("Debiased Model - Classification Accuracy: {:.2f}, Equal Opportunity Difference: {:.2f}".format(debias_model_classification_accuracy, debias_model_equal_opportunity_difference))
